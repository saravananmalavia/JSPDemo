...
<table width="100%" border="0">
  ...
  <li><a class="active" href="student_list.jsp">Delete</a></li>
  <li><a  href="student_insert.jsp">New</a></li>
                ...
                <tr>
                  <td align="center" valign="top">
                      <form id="form1" name="form1" method="post" action="student_delete_logic.jsp">
...
out.print(e.getMessage().toString());
					          ...
					          <td width="21%"><input type="submit" name="submit" id="submit" value="Submit"></td>
					          <td width="9%">&nbsp;</td>
					          <td width="9%">&nbsp;</td>
					          </tr>
					        </tbody>
